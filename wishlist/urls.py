...
urlpatterns = [
    ...
    path(
        'item/<int:pk>/move/<str:direction>/',
        views.wishlist_item_move,
        name='wishlist_item_move',
    ),
    ...
    path(
        'add-steam-game/<int:appid>/',
        views.add_steam_game_to_wishlist,
        name='add_steam_game_to_wishlist',
    ),
